...
Purpose: This script is to build the Decision Tree 5-year cancer survivability prediction model without the use of sampling techniques 
Source: SEER_final_dataset.csv
"""
#A DecisionTreeClassifier model is built based on processed data without the use of any sampling techniques
...
model = DecisionTreeClassifier(max_depth=5000)
