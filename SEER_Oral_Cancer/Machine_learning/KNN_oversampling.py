...
Purpose: This script is to build a K-Nearest Neighbhor model that was built based on processed data with the use of SMOTE sampling techniques
Source: SEER_final_dataset.csv
"""
#A KNN model is built based on processed data with the use of SMOTE sampling techniques
