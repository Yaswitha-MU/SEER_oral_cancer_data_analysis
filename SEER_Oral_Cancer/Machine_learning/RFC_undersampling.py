...
Purpose: This script is to build a Random Forest model is built based on processed data with the use of EDited KNN Under sampling techniques
Source: SEER_final_dataset.csv
"""
# A Random Forest model is built based on processed data with the use of EDited KNN Under sampling techniques
