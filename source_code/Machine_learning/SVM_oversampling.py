# -*- coding: utf-8 -*-
"""
Created on Fri Dec 11 04:06:35 2020
Last Modified Date - 18/02/2021
@author: Yaswitha Jampani
Purpose: This script is to build a Support Vector Machine model that was built based on processed data with the use of SMOTE sampling techniques
Source: SEER_final_dataset.csv
"""
#A SVM model is built based on processed data with the use of SMOTE over-sampling techniques
