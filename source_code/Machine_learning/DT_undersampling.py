...
Purpose: This script is to build a DecisionTreeClassifier model that was built based on processed data with the use of EDited KNN Under sampling techniques
Source: SEER_final_dataset.csv
"""
# A DecisionTreeClassifier model is built based on processed data with the use of EDited KNN Under sampling techniques
