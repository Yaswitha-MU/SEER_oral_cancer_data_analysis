...
Purpose: This script is to build a Logistic_regression model is built based on processed data with the use of KNN edited under sampling techniques
Source: SEER_final_dataset.csv
"""
# A Logistic_regression model is built based on processed data with the use of KNN edited under sampling techniques
