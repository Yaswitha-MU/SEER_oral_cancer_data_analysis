# -*- coding: utf-8 -*-
"""
Created on Tue Oct 20 17:44:03 2020
Last Modified Date - 18/02/2021
@author: Yaswitha Jampani
Purpose: This script is to build a Support Vector Machine model is built based on processed data without the use of any sampling techniques
Source: SEER_final_dataset.csv
"""
#A SVM model is built based on processed data without the use of any sampling techniques
